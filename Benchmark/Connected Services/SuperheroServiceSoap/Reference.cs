...
namespace SuperheroServiceSoap
{
    ...
    public partial class SuperheroServiceClient : System.ServiceModel.ClientBase<SuperheroServiceSoap.ISuperheroService>, SuperheroServiceSoap.ISuperheroService
    {
        ...
        private static System.ServiceModel.Channels.Binding GetBindingForEndpoint(EndpointConfiguration endpointConfiguration)
        {
            ...
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_ISuperheroService))
            {
                System.ServiceModel.BasicHttpBinding result = new System.ServiceModel.BasicHttpBinding();
                result.MaxBufferSize = int.MaxValue;
                result.ReaderQuotas = System.Xml.XmlDictionaryReaderQuotas.Max;
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ISuperheroService))
            {
                return new System.ServiceModel.EndpointAddress("http://wcfservice20211105010651.azurewebsites.net/SuperheroService.svc");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpsBinding_ISuperheroService))
            {
                return new System.ServiceModel.EndpointAddress("https://wcfservice20211105010651.azurewebsites.net/SuperheroService.svc");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
        ...
        public enum EndpointConfiguration
        {
            ...
            BasicHttpsBinding_ISuperheroService,
        }
    }
}
